...
KNOWN_EVENT(GCPhaseBegin, GCEventProvider_Default, GCEventLevel_Information, GCEventKeyword_GC)
KNOWN_EVENT(GCPhaseEnd, GCEventProvider_Default, GCEventLevel_Information, GCEventKeyword_GC)
